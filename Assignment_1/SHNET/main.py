...
def get_args_parser():
    ...
    # HYPER Params
    parser.add_argument("--lr", default=3e-4, type=float) #1.2e-4
    parser.add_argument("--batch_size", default=32, type=int)
    parser.add_argument("--weight_decay", default=1e-3, type=float) #9e-5
    ...
    parser.add_argument("--feature_dim", default=14, type=int) #20
    parser.add_argument("--dropout", default=0.3, type=float) #0.2
    ...
    parser.add_argument("--image_dim", type=int, default=448) #320
    parser.add_argument("--mask_dim", type=int, default=56) #160
    parser.add_argument("--channel_dim", type=int, default=512)
    parser.add_argument("--phrase_len", type=int, default=20) #30
...
def main(args):
    ...
    joint_model = JointModel(
        ...
        num_sfm_layers=args.num_encoder_layers, #num_encoder_layers
