...
# this code was taken from https://pytorch.org/vision/stable/_modules/torchvision/utils.html in order to have compatibility with pytorch 1.8 and cuda 10.1
